...
mp.events.add('characterSave', () => {
	...
	if(editorBrowser != null) {
        ...
        editorBrowser = null;
        lastScreenEffect = "MinigameTransitionIn";
...
mp.events.add('CreatorCamera', () => {
    ...
    if(editorBrowser == null) editorBrowser = mp.browsers.new('package://ui/character/Character.html#content-1');
